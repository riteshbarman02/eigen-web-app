...
rect.fill = '#276BB0'; // Fill color
rect.stroke = 'blue'; // Stroke color
...
function updateRotation() {
  ...
  function updateRotation2() {
    ...
    // Render the scene
   if(mueVal<=15){
    stress2Arrow.vertices[0].x=82-mueVal/2;
    stress2Arrow.vertices[4].x=81;
    stress2Arrow.vertices[2].x=81;
    stress2Arrow.vertices[1].x=76;
    stress2Arrow.vertices[3].x=76;
...
function textrotation(){
  ...
  text1.translation.x=200+60*Math.sin(-rotationInRadians+Math.PI/3);
  text1.translation.y=150+60*Math.cos(-rotationInRadians+Math.PI/3);
  text2.translation.x=200+60*Math.sin(-rotationInRadians+Math.PI);
  text2.translation.y=150+60*Math.cos(-rotationInRadians+Math.PI);
}
